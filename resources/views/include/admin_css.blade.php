...
<link rel="stylesheet" href="{{ asset('bootstrap-source/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}">
<!-- Font Awesome -->
...
<link rel="stylesheet" href="{{ asset('bootstrap3-dialog/css/bootstrap-dialog.min.css') }}">
